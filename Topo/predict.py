...
def main():
    ...
    parser.add_argument("--model", type=str, default="./runs/detect/train_on_gray/weights/best.pt", help="Path to the YOLO model file")
    parser.add_argument("--source", type=str,
                        default="./data/test_data/images/AIGIs",
                        help="Path to the input image")
    parser.add_argument("--imgsz", type=int, default=640, help="images size for inference")
    parser.add_argument("--show", default=False, action="store_true", help="Whether to display the result image")
    parser.add_argument("--save", default=True, action="store_true", help="Whether to save the result image")
    parser.add_argument("--single-cls", default=True)
