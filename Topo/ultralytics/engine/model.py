...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Args:
            source (str | Path | int | PIL.images | np.ndarray, optional): The source of the image for making
    ...
    def predict(
        ...
        **kwargs,
        ...
        Args:
            source (str | int | PIL.images | np.ndarray, optional): The source of the image for making predictions.
