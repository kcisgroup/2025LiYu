...
class Results(SimpleClass):
    ...
    def plot(
        ...
        """
        Plots the detection results on an input RGB image. Accepts a numpy array (cv2) or a PIL images.
        ...
        Args:
            ...
            pil (bool): Whether to return the image as a PIL images.
        ...
        Example:
            ...
            for r in results:
                ...
                im = images.fromarray(im_array[..., ::-1])  # RGB PIL image
                im.show()  # show image
...
class Boxes(BaseTensor):
    ...
    Attributes:
        data (torch.Tensor): The test_raw tensor containing detection boxes and their associated data.
...
class OBB(BaseTensor):
    ...
    Attributes:
        ...
        data (torch.Tensor): The test_raw OBB tensor (alias for `boxes`).
