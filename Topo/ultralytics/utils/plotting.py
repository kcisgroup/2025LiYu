...
class Annotator:
    ...
    Attributes:
        im (images.images or numpy array): The image to annotate.
    ...
    def __init__(self, im, line_width=None, font_size=None, font="Arial.ttf", pil=False, example="abc"):
        ...
        if self.pil:  # use PIL
            ...
            assert im.data.contiguous, "images not contiguous. Apply np.ascontiguousarray(im) to Annotator input images."
    ...
    def masks(self, masks, colors, im_gpu, alpha=0.5, retina_masks=False):
        ...
        Args:
            ...
            im_gpu (tensor): images is in cuda, shape: [3, h, w], range: [0, 1]
    ...
    def kpts(self, kpts, shape=(640, 640), radius=5, kpt_line=True):
        ...
        Args:
            ...
            shape (tuple): images shape as a tuple (h, w), where h is the height and w is the width.
