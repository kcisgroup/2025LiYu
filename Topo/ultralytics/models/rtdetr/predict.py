...
class RTDETRPredictor(BasePredictor):
    ...
    Attributes:
        imgsz (int): images size for inference (must be square and scale-filled).
        args (dict): Argument overrides for the predictor.
    """

    def postprocess(self, preds, img, orig_imgs):
        """
        Postprocess the test_raw predictions from the model to generate bounding boxes and confidence scores.
